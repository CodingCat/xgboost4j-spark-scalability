...
--jars KittenWhisker/target/kittenwhisker-0.2-jar-with-dependencies.jar,$JAVA_HOME/lib/tools.jar \
--conf spark.driver.extraJavaOptions="-javaagent:kittenwhisker-0.2-jar-with-dependencies.jar=waitingLength=20,targetDirectory=./flameperf/ -XX:+PreserveFramePointer" \
--conf spark.executor.extraJavaOptions="-javaagent:kittenwhisker-0.2-jar-with-dependencies.jar=waitingLength=20,targetDirectory=./flameperf/ -XX:+PreserveFramePointer" \
